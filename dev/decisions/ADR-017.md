...
## Consequences
*   Immediate development will proceed using an AWQ-quantized version of `Llama-3.1-8B-Instruct`. The `server/model_server/config.example.yaml` will be updated to reflect this.
